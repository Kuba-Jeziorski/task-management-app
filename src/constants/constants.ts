...
export const REWARD_CONTEXT_ERROR =
  "RewardContext was used outside of RewardContextProvider";
export const REWARD_REMOVING = "Are you sure you want to remove this reward?";
export const REWARD_TITLE = "Describe your reward";
export const REWARDS = "rewards";
export const REWARDS_TITLE = "reward yourself";
export const REWARDS_TOOLTIP = "Rewards tooltip";
...
export const SUCCESSFUL_REWARD_CREATE = "Successfully created a reward";
export const SUCCESSFUL_REWARD_REMOVE = "Successfully removed a reward";
export const SUCCESSFUL_REWARD_UPDATE = "Successfully updated a reward";
